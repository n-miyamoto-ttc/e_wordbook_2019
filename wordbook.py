...
###方法2:
    ...
    for word, count in counter.most_common(): # most_common():https://blog.csdn.net/zyx_ly/article/details/88202672
        if len(word) > 0:
            dic_list[word] = ['日訳意味',str(count)]#create a space for meaning in 'count'
    #print(dic_list)
    print("*******************************************")
    print("単語             意味            出現回数")
    i=0
...
# # 4.print rsesult in Json file(need to change)    
...
# 4·把前10 结果的·list`变成词典然后加上新的key即日文解释
# change the list of the ten words into dictionary, then add a new key
